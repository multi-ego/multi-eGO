...
def parametrize_LJ(meGO_ensemble, parameters):
    ...
    if parameters.egos != 'rc':
        ...
        meGO_LJ_14 = meGO_LJ_14.drop(columns = ['sigma_y', 'epsilon_y', 'same_chain_y', 'probability_y', 'rc_probability_y', 'source_y', '1-4_y'])#, inplace = True)
