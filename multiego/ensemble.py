...
def generate_LJ(meGO_ensemble, train_dataset, check_dataset, parameters):
    ...
    meGO_LJ.loc[(meGO_LJ['probability']>limit_rc*np.maximum(meGO_LJ['rc_probability'],parameters.rc_threshold))&(meGO_LJ['same_chain']==True)&(meGO_LJ['distance_m']<=meGO_LJ['rc_distance_m'])&(meGO_LJ['rc_probability']>parameters.md_threshold), 'epsilon'] = -(parameters.epsilon/np.log(parameters.rc_threshold))*(np.log(meGO_LJ['probability']/np.maximum(meGO_LJ['rc_probability'],parameters.rc_threshold)))
    meGO_LJ.loc[(meGO_LJ['probability']>limit_rc*np.maximum(meGO_LJ['rc_probability'],parameters.rc_threshold))&(meGO_LJ['same_chain']==True)&(meGO_LJ['distance_m']>meGO_LJ['rc_distance_m'])&(meGO_LJ['rc_probability']>parameters.md_threshold), 'epsilon'] = 0 
    ...
    meGO_LJ.loc[(meGO_LJ['probability']>limit_rc*np.maximum(meGO_LJ['rc_probability'],parameters.rc_threshold))&(meGO_LJ['same_chain']==False)&(meGO_LJ['distance_m']<=meGO_LJ['rc_distance_m'])&(meGO_LJ['rc_probability']>parameters.md_threshold), 'epsilon'] = -(parameters.inter_epsilon/np.log(parameters.rc_threshold))*(np.log(meGO_LJ['probability']/np.maximum(meGO_LJ['rc_probability'],parameters.rc_threshold)))
    meGO_LJ.loc[(meGO_LJ['probability']>limit_rc*np.maximum(meGO_LJ['rc_probability'],parameters.rc_threshold))&(meGO_LJ['same_chain']==False)&(meGO_LJ['distance_m']>meGO_LJ['rc_distance_m'])&(meGO_LJ['rc_probability']>parameters.md_threshold), 'epsilon'] = 0 
