...
def parametrize_LJ(topology_dataframe, molecule_type_dict, bond_tuple, pairs_tuple, type_c12_dict, meGO_atomic_contacts, reference_atomic_contacts, check_atomic_contacts, sbtype_number_dict, parameters):
    ...
    if parameters.egos != 'rc':
        ...
        # Remove flagged
        meGO_atomic_contacts_merged = meGO_atomic_contacts_merged.loc[(meGO_atomic_contacts_merged['flag']>0)|((meGO_atomic_contacts_merged['flag']==0)&(meGO_atomic_contacts_merged['distance']<np.minimum(meGO_atomic_contacts_merged['rep']**(1./12.)+0.12,0.5)))]
