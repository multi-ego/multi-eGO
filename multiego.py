...
def main(argv):
    ...
    if parameters['egos'] == 'rc':
        parameters['output_folder'] = f"outputs/output_{parameters['protein']}_{parameters['egos']}"
    else:
        parameters['output_folder'] = f"outputs/output_{parameters['protein']}_{parameters['egos']}_e{parameters['epsilon_input']}"
