...
python ../tools/make_mat/make_mat.py --zero --target_top test_inputs/make_mat_ttr/topol_mego.top --mego_top test_inputs/make_mat_ttr/topol.top --cutoff 0.75 --mode intra+same --out  test_inputs/make_mat_ttr/
python ../tools/make_mat/HDF52ndx.py --input test_inputs/make_mat_ttr/intramat_1_1.ndx.h5 
python ../tools/make_mat/HDF52ndx.py --input test_inputs/make_mat_ttr/intermat_1_1.ndx.h5 
diff test_inputs/make_mat_ttr/intramat_1_1.ndx test_outputs/make_mat_ttr/intramat_1_1.ndx.zero
diff test_inputs/make_mat_ttr/intermat_1_1.ndx test_outputs/make_mat_ttr/intermat_1_1.ndx.zero
