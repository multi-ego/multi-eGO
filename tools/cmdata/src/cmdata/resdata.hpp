#ifndef _CMDATA_RESDATA_HPP
#define _CMDATA_RESDATA_HPP
...
private:
  ...
  // stolen from carlo's code
  std::vector<int> res_natm(t_atoms& atoms)
  {
    std::vector<int> natm;
    int  i, j, r0;
